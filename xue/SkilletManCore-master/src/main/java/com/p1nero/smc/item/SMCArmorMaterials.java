...
public enum SMCArmorMaterials implements ArmorMaterial {
    ...
    SMCArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound,
    ...
    public @NotNull String getName() {
        return SkilletManCoreMod.MOD_ID + ":" + this.name;
    }
